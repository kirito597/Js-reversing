...
window.addEventListener = function (args){
    console.log("对象 =>window,方法：" + "addEventListener" + "，入参：" + args)
}
//刚刚是一个未定义的值，经过下面的js代码，window.CHAMELEON_LOADED = true;
//window.CHAMELEON_LOADED = true;
window.location = {
    "ancestorOrigins": {},
    "href": "https://data.10jqka.com.cn/market/longhu/",
    "origin": "https://data.10jqka.com.cn",
    "protocol": "https:",
    "host": "data.10jqka.com.cn",
    "hostname": "data.10jqka.com.cn",
    "port": "",
    "pathname": "/market/longhu/",
    "search": "",
    "hash": ""
}
...
document = {
    ...
    getElementsByTagName: function (args) {
        console.log("对象 =>document,方法：" + "getElementByTagName" + "，入参：" + args)
    },
    createElement: function (args) {
        console.log("对象 =>document,方法：" + "createElement" + "，入参：" + args)
        if (args === "div") {
            aaa = watch(div, "div")
            return aaa
        }
    ...
    addEventListener: function (args) {
        console.log("对象 =>document,方法：" + "addEventListener" + "，入参：" + args)
    }
}
document = watch(document, "document")

var TOKEN_SERVER_TIME = 1754803862.843;
!function(n, t, r, e) {
    !function() {
        var a = r[0]
          , u = n[0]
